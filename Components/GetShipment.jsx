          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            {singleShipmentData == undefined ? (
              ...
              <div className="text-left">
                ...
                <p>Pickup Date: {converTime(singleShipmentData.pickupTime)}</p>
                <p>Delivery Date: {converTime(singleShipmentData.pickupTime)}</p>
                <p>Distance: {singleShipmentData.distance + ` mi`}</p>
